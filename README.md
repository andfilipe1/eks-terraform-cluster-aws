...
> You can create a file called terraform.tfvars or copy [variables.tf](https://github.com/andfilipe1/eks-terraform-cluster-aws/blob/master/variables.tf) into the project root, if you would like to over-ride the defaults.

## How to use this example

```bash
git clone https://github.com/andfilipe1/eks-terraform-cluster-aws.git
cd eks-terraform-cluster-aws
```
